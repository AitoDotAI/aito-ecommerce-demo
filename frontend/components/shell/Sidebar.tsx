...
const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/markdown",       label: "Markdown",        icon: "✂️", badge: { text: "New" } },
      { href: "/cart-completion",label: "Cart Completion", icon: "🛒", badge: { text: "New" } },
      { href: "/winback",        label: "Win-back",        icon: "↩️", badge: { text: "New" } },
    ],
  },
  {
    label: "Automate",
